...
COLORS = (S1, S2, S3, S4, S1, S2, S3, S4, S1D, S2D, S3D, S4D, S1D, S2D, S3D, S4D)
...
<style>
  ...
  .s1{{fill:{0}}} .s2{{fill:{1}}} .s3{{fill:{2}}} .s4{{fill:{3}}}
  .l1{{stroke:{4}}} .l2{{stroke:{5}}} .l3{{stroke:{6}}} .l4{{stroke:{7}}}
  .ring{{stroke:#fcfcfb}}
  ...
  @media (prefers-color-scheme: dark) {{
    ...
    .s1{{fill:{8}}} .s2{{fill:{9}}} .s3{{fill:{10}}} .s4{{fill:{11}}}
    .l1{{stroke:{12}}} .l2{{stroke:{13}}} .l3{{stroke:{14}}} .l4{{stroke:{15}}}
  }}
</style>
...
def write(name, w, h, body):
    with open(f'{OUT}/{name}.svg', 'w') as f:
        f.write(HEAD.format(*COLORS, w=w, h=h) + body + '</svg>\n')
