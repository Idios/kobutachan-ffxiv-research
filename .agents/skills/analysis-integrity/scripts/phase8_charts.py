...
_gA = SE.groupA
from phase7_forecast import E7, SCEN, build, simulate
...
def chart_cycles():
    ...
    with open(f'{OUT}/cycle-curves.svg', 'w') as _f:
        _f.write(svg(
...
def chart_forecast():
    ...
    with open(f'{OUT}/forecast.svg', 'w') as _f:
        _f.write(svg(
...
def chart_tornado():
    ...
    for i, r in enumerate(rows):
        ...
        _dash = f' stroke-dasharray="4 3" stroke="{col}" stroke-width="1"' if r[4] == 'C' else ''
    ...
    with open(f'{OUT}/tornado.svg', 'w') as _f:
        _f.write(svg(
...
def chart_backcast():
    ...
    with open(f'{OUT}/backcast.svg', 'w') as _f:
        _f.write(svg(
